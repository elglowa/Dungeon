...
public class Armor extends AbstractItem
{
    ...
    @Override
    public void addHP(double hp) { Mob1.addHP(HpPoints+hp+Mob1.getHealth()/40); }

    @Override
    public void addArmour(double armour) { Mob1.addArmour(ArmourPoints+armour+Mob1.getDefence()/30); }
}
